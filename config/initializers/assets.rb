...
Rails.application.config.assets.precompile += %w( js/owl.carousel.js )
Rails.application.config.assets.precompile += %w( js/jquery.mb.YTPlayer.min.js )
Rails.application.config.assets.precompile += %w( js/rellax.min.js )
Rails.application.config.assets.precompile += %w( js/jquery.fancybox.min.js )
Rails.application.config.assets.precompile += %w( js/progressbar.min.js )
...
Rails.application.config.assets.precompile += %w( jquery.mb.YTPlayer.min.css )
